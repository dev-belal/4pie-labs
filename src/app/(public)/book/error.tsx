...
export default function BookError({
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6 py-20">
      <div className="max-w-2xl w-full glass-morphism rounded-[32px] border border-red-500/20 p-8 md:p-10 text-foreground">
        ...
        <div className="bg-background/40 border border-foreground/10 rounded-2xl p-4 mb-6 font-mono text-xs leading-relaxed overflow-x-auto">
