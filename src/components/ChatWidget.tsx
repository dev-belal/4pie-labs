...
export function ChatWidget() {
  ...
  const handleSendMessage = async (text: string) => {
    ...
    try {
      ...
      const botText =
        data.reply?.trim() ||
        "I'm having a bit of trouble right now - you can also email us at hello@fourpielabs.com.";
      ...
      const errorMsg: Message = {
        id: (Date.now() + 1).toString(),
        text: "I'm having a bit of trouble connecting right now. Please feel free to [book a discovery call](/book) or email us at hello@fourpielabs.com.",
        sender: "bot",
        timestamp: new Date(),
      };
