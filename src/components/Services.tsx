...
export const Services = ({ onSeeMore, onContactClick }: { onSeeMore: () => void, onContactClick: () => void }) => {
    ...
    return (
        <section id="services" className="py-24 px-4 bg-[#030303] overflow-hidden relative">
            {/* Section Decor */}
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-white/40 max-w-2xl mx-auto text-lg mb-12">
                        We don't just "implement AI." We build the foundation for an autonomous agency.
                    </p>
                    ...
                    <AnimatePresence mode="popLayout">
                        {filteredServices.map((service) => (
                            <motion.div
                                ...
                                className="group relative p-8 glass-morphism rounded-[32px] border-white/10 hover:border-white/20 hover:bg-white/[0.07] transition-all cursor-pointer overflow-hidden shadow-2xl"
                            >
                                <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />

                                <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${service.color} p-0.5 mb-6 group-hover:scale-110 transition-transform`}>
                ...
                <div className="mt-16 text-center">
                    <button
                        onClick={onSeeMore}
                        className="group flex items-center gap-3 mx-auto bg-white/5 hover:bg-white/10 text-white px-10 py-5 rounded-full text-lg font-bold transition-all border border-white/10 hover:border-white/20 active:scale-95"
                    >
                        See More Services
