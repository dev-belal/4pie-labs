...
export const CustomDropdown = ({ options, value, onChange, placeholder, icon, label }: CustomDropdownProps) => {
                            ...
                            {options.map((option) => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        option.value === value ? "text-primary font-bold bg-primary/5" : "text-white/60"
                                    )}
                                >
                                    {option.label}
