import {
    Bot, Zap, TrendingUp, Shield, Cpu, MessageSquare,
    PenTool, Palette, Megaphone, Sparkles, Image, Share2,
    Globe, Target, MousePointerClick, Mail,
    FileText, Magnet
} from 'lucide-react';

export const categories = ["AI Systems", "Design Creatives", "Digital Marketing"];
...
export const services = [
    // AI Systems
    {
        ...
        category: "AI Systems",
        details: "Full integration with your legacy tools. Secure, private, and managed by our team.",
        points: [
        ...
        seoDesc: "Transform your agency with a custom AI Operating System. Our enterprise-grade solutions automate business logic, reduce manual data entry, and enable autonomous task execution across your entire tech stack."
    },
    {
        ...
        seoDesc: "Scalable workflow automation solutions designed for modern agencies. We build robust, error-free systems that handle complex business processes, allowing your team to focus on high-level growth and strategy."
    },
    {
        ...
        seoDesc: "Unlock the power of your data with AI-driven intelligence. Our custom models identify trends, predict outcomes, and provide the clarity needed for data-backed decision making in a competitive market."
    },
    {
        ...
        seoDesc: "Deploy intelligent autonomous agents to handle the heavy lifting. From instant customer support to automated lead scoring, our AI agents provide consistent, high-quality performance around the clock."
    },
    {
        ...
        seoDesc: "Scalable and secure AI integrations for enterprise. We prioritize data privacy and security, ensuring your AI initiatives meet the highest global standards for compliance and protection."
    },
    {
        ...
        seoDesc: "Revolutionize your customer experience with cognitive AI support. Our systems go beyond simple keywords, understanding intent and sentiment to provide helpful, accurate, and instant resolutions."
    },
    // Design Creatives
    {
        ...
        points: [
            "Stunning 3D Renders and Spline integrations",
        ...
        seoDesc: "Premium content creation services to amplify your brand. We combine high-end design principles with modern technology to deliver visual assets that capture attention and drive meaningful engagement."
    },
    {
        ...
        seoDesc: "Elevate your brand with strategic visual optimization. We refine your identity to ensure consistency, professionalism, and impact across every touchpoint of your customer journey."
    },
    {
        title: "Ad Creatives",
        ...
        seoDesc: "Performance-driven ad creatives that deliver ROI. Our designs aren't just beautiful—they're scientifically engineered to stop the scroll, increase click-through rates, and drive conversions."
    },
    {
        ...
        seoDesc: "Modernize your existing assets with AI content optimization. We breathe new life into your content library, improving quality and performance while maximizing the value of your existing work."
    },
    {
        ...
        seoDesc: "Scale your creative production with AI content generation. We build custom pipelines that generate unique, high-quality visuals on demand, perfectly aligned with your brand identity."
    },
    {
        ...
        seoDesc: "Stand out in a crowded feed with premium social media design. Our social-first approach ensures your brand stays relevant, engaging, and visually stunning across every platform."
    },
    // Digital Marketing
    {
        ...
        seoDesc: "Dominate the search engine results pages with our advanced SEO optimization services. We use data-driven strategies and AI tools to increase visibility, drive organic traffic, and build long-term authority."
    },
    {
        ...
        points: [
            ...
            "Transparent ROI and performance dashbaords"
        ],
        seoDesc: "Accelerate your growth with expert PPC management. Our performance-first approach ensures every dollar is spent efficiently, delivering high-quality leads and measurable ROI across all paid channels."
    },
    {
        ...
        seoDesc: "Scale your digital footprint with strategic social media marketing. We go beyond simple posting, building active communities and high-engagement campaigns that turn followers into brand advocates."
    },
    {
        ...
        seoDesc: "Drive massive ROI with automated email marketing. Our lifecycle-focused strategies nurture leads through the funnel, delivering personalized value that increases lifetime customer value and retention."
    },
    {
        ...
        seoDesc: "Build a content engine that drives sustainable growth. Our holistic content strategies align your message with user intent, building trust and authority across every digital touchpoint."
    },
    {
        ...
        seoDesc: "Maximize every visitor with data-driven conversion rate optimization. We use scientific testing and psychological triggers to remove friction and turn more of your traffic into loyal, paying customers."
    }
];
