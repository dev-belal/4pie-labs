-- Phase 1 seed: insert the 7 current static articles from
-- src/data/blogs.ts into the Supabase blogs table.
--
-- Generated by scripts/generate-blog-seed-sql.mts from the canonical
-- source in src/data/blogs.ts. Each row is byte-identical to the
-- static fallback that getAllPosts() / getPostBySlug() serve when the
-- table is empty. After this seed runs, those functions will start
-- serving from Supabase (they prefer DB over static).
--
-- Idempotent: every INSERT carries `on conflict (id) do nothing`, so
-- re-running this file is a no-op. The id column doubles as a primary
-- key and equals the slug.
--
-- Prerequisite: migration 0008_add_blog_faqs_iso_widen_category.sql
-- must already have run (adds the `faqs` and `date_published_iso`
-- columns and drops the legacy category check constraint).
--
...
insert into public.blogs (
  ...
  $BLOGSEED$tour-businesses-losing-customers-ai-search$BLOGSEED$,
  $BLOGSEED$tour-businesses-losing-customers-ai-search$BLOGSEED$,
  $BLOGSEED$Why Tour Businesses Are Losing Customers to AI Search (And How to Fix It)$BLOGSEED$,
  $BLOGSEED$Answer Engine Optimization$BLOGSEED$,
  $BLOGSEED$Syed Belal$BLOGSEED$,
  $BLOGSEED$June 3, 2026$BLOGSEED$,
  $BLOGSEED$8 min read$BLOGSEED$,
  $BLOGSEED$/blog/ai-search-tours/header.jpg$BLOGSEED$,
  $BLOGSEED$Travelers now ask ChatGPT and Perplexity for tour recommendations before they ever reach Google. If AI never cites you, you lose the booking first.$BLOGSEED$,
  $BLOGSEED$
...
If you want to know whether AI engines currently recommend your tour business, or recommend your competitors instead, a [free audit](/audit) of your visibility across traditional search, Google Business Profile, and AI answer engines is the clearest place to start. That is exactly the work we do at 4Pie Labs.
    $BLOGSEED$,
  $BLOGSEED$[{"q":"Why are tour businesses losing customers to AI search?","a":"Travelers increasingly ask ChatGPT, Perplexity, and Google AI Overviews for recommendations before they reach a traditional search results page. If those engines do not cite your business, the traveler often books a competitor that was cited, and you never see the lost booking."},{"q":"How do I get my tour business recommended by ChatGPT and Perplexity?","a":"Structure your site so answer engines can extract and trust it: lead pages with a direct answer to the question travelers ask, add FAQ sections marked up with FAQPage schema, keep content current, and build consistent third-party signals like reviews and directory listings. This is the practice of answer engine optimization."},{"q":"How fast can a tour business start showing up in AI answers?","a":"Structural changes often appear in Perplexity within roughly one to two weeks and in ChatGPT within a few weeks, because their retrieval refreshes faster than traditional search rankings. It is one of the fastest visibility wins available right now."}]$BLOGSEED$::jsonb,
  $BLOGSEED$2026-06-03$BLOGSEED$,
  0
)
...
insert into public.blogs (
  ...
  $BLOGSEED$best-marketing-agency-tour-operators$BLOGSEED$,
  $BLOGSEED$best-marketing-agency-tour-operators$BLOGSEED$,
  $BLOGSEED$How to Find the Best Marketing Agency for Your Tour Business$BLOGSEED$,
  $BLOGSEED$Local SEO$BLOGSEED$,
  $BLOGSEED$Syed Belal$BLOGSEED$,
  $BLOGSEED$June 2, 2026$BLOGSEED$,
  $BLOGSEED$9 min read$BLOGSEED$,
  $BLOGSEED$/blog/tour-operator-marketing/header.jpg$BLOGSEED$,
  $BLOGSEED$The best marketing agency for a tour business ties spend to booked tours, understands how travelers actually decide, and proves results, not just reports.$BLOGSEED$,
  $BLOGSEED$
...
If you want to see where your tour business stands before you spend anything, a [free audit](/audit) of your current visibility across traditional search, Google Business Profile, paid advertising, and AI search is the clearest place to start. That is exactly the work we do at 4Pie Labs.
    $BLOGSEED$,
  $BLOGSEED$[{"q":"How do I choose the best marketing agency for my tour business?","a":"Look for an agency that ties spend to booked tours rather than to impressions and clicks, understands how travelers actually decide (planners who research for months versus same-day bookers), tracks revenue and cost per booking, and can explain its strategy in plain terms. Ask for revenue-tied results, not ranking screenshots."},{"q":"Why is marketing for tour operators different from other businesses?","a":"Tour businesses serve two very different buyers at once: long-lead planners who research for months before traveling, and same-day bookers deciding on the spot. Marketing has to reach both with different strategies, and most generic agencies build for only one, missing half the demand."},{"q":"Should a tour operator invest in AI search optimization?","a":"Yes. Travelers increasingly ask ChatGPT, Perplexity, and Google AI Overviews for recommendations like \"best tour for families\" before they ever reach a search results page. Tour operators who structure their content to be cited in those answers reach travelers at the moment they are deciding, and most competitors have not optimized for this yet."}]$BLOGSEED$::jsonb,
  $BLOGSEED$2026-06-02$BLOGSEED$,
  0
)
on conflict (id) do nothing;
...
insert into public.blogs (
  ...
  $BLOGSEED$best-google-ads-management-local-service-businesses$BLOGSEED$,
  $BLOGSEED$best-google-ads-management-local-service-businesses$BLOGSEED$,
  $BLOGSEED$What the Best Google Ads Management Looks Like for Local Service Businesses$BLOGSEED$,
  $BLOGSEED$Performance Ads$BLOGSEED$,
  $BLOGSEED$Syed Suqlain$BLOGSEED$,
  $BLOGSEED$June 3, 2026$BLOGSEED$,
  $BLOGSEED$8 min read$BLOGSEED$,
  $BLOGSEED$/blog/google-ads/header.jpg$BLOGSEED$,
  $BLOGSEED$The best Google Ads management for local service businesses ties every dollar to a booked job, with intent-led keywords, full tracking, and active tuning.$BLOGSEED$,
  $BLOGSEED$
...
insert into public.blogs (
  ...
  $BLOGSEED$is-seo-still-important-2026$BLOGSEED$,
  $BLOGSEED$is-seo-still-important-2026$BLOGSEED$,
  $BLOGSEED$Is SEO Still Important in 2026? Here's What the Data Really Says$BLOGSEED$,
  $BLOGSEED$SEO$BLOGSEED$,
  $BLOGSEED$Syed Suqlain$BLOGSEED$,
  $BLOGSEED$June 1, 2026$BLOGSEED$,
  $BLOGSEED$9 min read$BLOGSEED$,
  $BLOGSEED$/blog/seo-2026/header.jpg$BLOGSEED$,
  $BLOGSEED$SEO is not dead in 2026. AI Mode changed how answers appear, but search still drives revenue. Here is what the data shows local businesses should do.$BLOGSEED$,
  $BLOGSEED$
...
If you want to understand what an updated strategy looks like for your specific business and market, that is exactly the kind of work we do at 4Pie Labs. We build SEO and AI citation visibility together, so local service businesses get found first in both traditional search and the AI answers that are quietly reshaping how customers choose who to call.
    $BLOGSEED$,
  $BLOGSEED$[{"q":"Is SEO still important in 2026?","a":"Yes. AI Mode changed how answers are displayed, but traditional blue-link results and organic search still drive significant revenue, especially for transactional and local queries. SEO and answer engine optimization now work together rather than one replacing the other."},{"q":"Did AI search kill SEO?","a":"No. AI Overviews became the default answer surface for many informational queries, but Google did not remove organic results and never announced any plan to deprecate classic ranking. The signals that win in AI search are an extension of strong SEO, not a replacement for it."},{"q":"Should local businesses still invest in SEO?","a":"Yes. SEO and AI citation authority compound over time. A business that keeps investing builds more authority, indexed content, and citation opportunities, while one that stops falls behind and pays more to catch up later."},{"q":"What is the difference between SEO and AEO in 2026?","a":"SEO ranks your page in a list of results users click. AEO, answer engine optimization, structures your content so AI engines cite it directly in their answers. Both share the same technical foundation, so the strongest sites win in search and AI answers at once."}]$BLOGSEED$::jsonb,
  $BLOGSEED$2026-06-01$BLOGSEED$,
  0
)
on conflict (id) do nothing;
...
insert into public.blogs (
  ...
  $BLOGSEED$local-business-chatgpt-visibility$BLOGSEED$,
  $BLOGSEED$local-business-chatgpt-visibility$BLOGSEED$,
  $BLOGSEED$Why Your Local Business Isn't Showing Up in ChatGPT (And How to Fix It)$BLOGSEED$,
  $BLOGSEED$AEO$BLOGSEED$,
  $BLOGSEED$Syed Belal$BLOGSEED$,
  $BLOGSEED$May 28, 2026$BLOGSEED$,
  $BLOGSEED$6 min read$BLOGSEED$,
  $BLOGSEED$https://cdn.pixabay.com/photo/2015/07/17/22/43/student-849826_1280.jpg$BLOGSEED$,
  $BLOGSEED$If ChatGPT and Perplexity never mention your business, it's usually because your site isn't structured for AI to read, trust, and cite. Here's what to fix first.$BLOGSEED$,
  $BLOGSEED$
## The short answer
...
Be your own customer. Open ChatGPT, Perplexity, and Google's AI results and ask the questions your buyers would ask: "best [your service] in [your city]," "how do I choose a [your service] provider," "is [your business name] any good." Note who gets cited. If it's never you, that's your baseline. Perplexity is the fastest place to test changes, since its citations update within days.
    $BLOGSEED$,
  $BLOGSEED$[{"q":"Why doesn't my business show up in ChatGPT?","a":"Usually because your website content isn't structured for AI to read and trust. AI answer engines extract facts from clear page text and structured data. If your key information is hidden in images, popups, or vague marketing copy, the engine skips you and cites a competitor."},{"q":"How long does it take to start appearing in AI search?","a":"Structural changes like adding FAQ content and clearer answers can show up in Perplexity within days and in ChatGPT within a few weeks. Building lasting trust and consistent citations takes months of steady work."},{"q":"Is showing up in ChatGPT different from ranking on Google?","a":"Yes. Google ranks you in a list of links. AI answer engines cite you as the single source in a written answer. They share the same technical foundation, but AI citation rewards clear answers, structured data, and freshness more heavily than traditional rankings reward keywords and backlinks."},{"q":"Do I need to be on every AI platform?","a":"Citation overlap between engines is low, so appearing in one doesn't guarantee the others. Start with the platforms your customers actually use, structure your content well, and you'll improve your odds across all of them at once."}]$BLOGSEED$::jsonb,
  $BLOGSEED$2026-05-28$BLOGSEED$,
  0
)
on conflict (id) do nothing;
...
insert into public.blogs (
  ...
  $BLOGSEED$painting-contractor-google-leads$BLOGSEED$,
  $BLOGSEED$painting-contractor-google-leads$BLOGSEED$,
  $BLOGSEED$How Painting Contractors Get More Leads From Google in 2026$BLOGSEED$,
  $BLOGSEED$Local SEO$BLOGSEED$,
  $BLOGSEED$Syed Belal$BLOGSEED$,
  $BLOGSEED$May 19, 2026$BLOGSEED$,
  $BLOGSEED$7 min read$BLOGSEED$,
  $BLOGSEED$https://cdn.pixabay.com/photo/2016/07/23/19/36/painter-1537421_1280.jpg$BLOGSEED$,
  $BLOGSEED$For painting contractors, most online leads come from three places: the Google Maps pack, a complete Google Business Profile, and pages that answer what homeowners actually search. Here's how to win all three.$BLOGSEED$,
  $BLOGSEED$
## The short answer
...
Track three numbers monthly: your position in the Maps pack for your top three search terms, your call and form volume from Google, and your review count and average rating. If the Maps position improves and reviews climb, the leads follow.
    $BLOGSEED$,
  $BLOGSEED$[{"q":"How do painting contractors rank higher in the Google Maps pack?","a":"The biggest factors are a complete Google Business Profile, consistent name/address/phone across the web, proximity to the searcher, and a steady stream of recent reviews. Upload real job photos regularly and ask every happy customer for a review the day the job finishes."},{"q":"Are Google ads worth it for painters?","a":"They can be, especially Local Services Ads, which charge per lead instead of per click and show a Google Guaranteed badge. Ads work best layered on top of a strong Business Profile and review base, not as a replacement for them."},{"q":"How long does it take to see more leads from Google?","a":"Profile and review improvements can lift Maps visibility within weeks. Content and organic ranking build over a few months. Paid ads produce leads immediately but stop when you stop paying."},{"q":"What website pages help painting contractors get leads?","a":"Pages that answer real homeowner questions: cost to paint a home, how long a job takes, interior vs exterior prep, and paint durability. Clear, direct answers on these pages capture research-stage buyers and get cited by AI search engines."}]$BLOGSEED$::jsonb,
  $BLOGSEED$2026-05-19$BLOGSEED$,
  0
)
on conflict (id) do nothing;
...
insert into public.blogs (
  ...
  $BLOGSEED$aeo-vs-seo-local-business$BLOGSEED$,
  $BLOGSEED$aeo-vs-seo-local-business$BLOGSEED$,
  $BLOGSEED$AEO vs SEO: What Local Service Businesses Need to Know$BLOGSEED$,
  $BLOGSEED$AEO$BLOGSEED$,
  $BLOGSEED$Syed Belal$BLOGSEED$,
  $BLOGSEED$May 8, 2026$BLOGSEED$,
  $BLOGSEED$5 min read$BLOGSEED$,
  $BLOGSEED$https://cdn.pixabay.com/photo/2021/02/26/10/47/freelance-6051356_1280.jpg$BLOGSEED$,
  $BLOGSEED$SEO gets you into Google's list of results. AEO gets you cited as the single answer in ChatGPT, Perplexity, and Google AI Overviews. Local businesses need both, and they share the same foundation.$BLOGSEED$,
  $BLOGSEED$
## The short answer
...
Don't choose between AEO and SEO. Build one strong foundation: a fast site, clear answers, FAQ content, structured data, consistent local presence. The same foundation serves both. Then test: ask the AI engines the questions your customers ask, see who gets cited, and refine. Perplexity shows results fastest; use it as your feedback loop.
    $BLOGSEED$,
  $BLOGSEED$[{"q":"What's the difference between AEO and SEO?","a":"SEO optimizes to rank in a list of search results. AEO optimizes to be cited as the single answer AI engines generate. SEO gets you into the conversation; AEO makes you the answer. They share the same technical foundation."},{"q":"Do local businesses need AEO if they already do SEO?","a":"Increasingly, yes. A growing share of buyers get answers from AI before clicking any link. If your business isn't cited in those answers, you're invisible in a fast-growing discovery channel, even if you rank on traditional Google."},{"q":"Is AEO harder than SEO for a small business?","a":"In some ways it's easier. AEO rewards clear, well-structured answers over raw domain authority and backlinks, so a small local business with sharp, specific content can get cited for niche questions where it could never outrank national brands in classic search."},{"q":"Can I do AEO and SEO with one website?","a":"Yes. They share the same foundation: a fast, clearly structured site with direct answers and schema markup. You optimize once and benefit in both traditional and AI search."}]$BLOGSEED$::jsonb,
  $BLOGSEED$2026-05-08$BLOGSEED$,
  0
)
on conflict (id) do nothing;
...
--   select id, category, date_published_iso, jsonb_array_length(faqs) as faqs
--   from public.blogs
--   order by date_published_iso desc nulls last;
-- Expected: 7 rows, every row has a category, a date_published_iso, and
-- faqs >= 3.
